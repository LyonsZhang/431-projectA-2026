---
title: "Task A: Create your own website"
...
- Please read sections 11 and 28-29 of [R for Data Science](https://r4ds.hadley.nz/).

----

## NEW! Completed Websites by Students in last year's class
- [Alex Epp](https://atepp2001.github.io/)
- [Victor Manuel Pastrana-Gómez](https://vpastrana7.github.io/)
- [Bosco Bakwatanisa](https://muto65.github.io/)
...
Task A requires you to build a professional website, or augment your
...
To complete this task successfully, you must submit a permanent URL from
which Dr. Zhang has to be able to open your website and read its
contents.

# Submitting your Website

Submit a link to your website to Dr. Zhang (lxz716@case.edu) and cc'ed TAs TAs Kathryn Menta	(kkm83@case.edu) and Marie Masotya (msm191@case.edu) in an email with the subject
line **My Website** by the deadline specified in the Course
Calendar. In the body of your email, briefly tell me how you created the site (Quarto, or something else.)
...
Dr. Zhang will be happy if your site clearly includes at least the
...
- Marvin Schmitt provides a full tutorial and template at [Create Your
  Website with
  Quarto](https://marvin-schmitt.com/blog/website-tutorial-quarto/).
  The template [shown
...
- We found Drew Dimmery’s [Quarto for an Academic
  ...
  useful.
- [Chi Zhang’s site](https://chizapoth.github.io/qtwAcademic/articles/template_personal.html)
...
receive. So I don't suggest you to use something else.
...
- Task A is worth 45 points.
- Students will receive all 45 points if ...
    - their Task A  submission is on time, and
    - their Task A site was built using Quarto, and
    - their Task A site clearly includes [the five key elements listed above](#the-five-key-elements), and
    - their Task A site has no unfixed typos or grammatical issues that Dr. Zhang notices in his review.
- Students will receive a maximum of 40/45 points if their site was built using something other than Quarto, but otherwise meets these standards.
